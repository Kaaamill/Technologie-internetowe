...
<div class="container">
    <div class="main">
        ...
        <div class="container_2">
                    ...
                    <div class="druga">
                        <a href="strona_glowna_uzytkownik.php?ksiazka=k2" target="_blank" title="Zobacz recenzje">
                            <div class="image-container"> <img width="120" src="../../img/hpkf.jpg" /> <a href="Wypozyczenie.html" class="rent-button">Wypożycz</a>
                            </div>
                        </a><br/>
                        <a href="strona_glowna_uzytkownik.php?ksiazka=k2" target="_blank" title="Zobacz recenzje">Harry Potter i Kamień Filozoficzny</a>
                    </div>


                          <div class="druga">
                                          <a href="strona_glowna_uzytkownik.php?ksiazka=k3" target="_blank" title="Gra o tron (edycja ilustrowana)">
                                              <div class="image-container"> <img width="120" src="../../img/3.jpg"/><a href="Wypozyczenie.html" class="rent-button">Wypożycz</a>
                                              </div>
                                          </a><br/>
                                          <a href="strona_glowna_uzytkownik.php?ksiazka=k3" target="_blank" title="Zobacz recenzje">Gra o tron (edycja ilustrowana)</a>
                                      </div>

                                      <div class="druga">
                                          <a href="strona_glowna_uzytkownik.php?ksiazka=k4" target="_blank" title="Miecz przeznaczenia">
                                              <div class="image-container">  <img width="120" src="../../img/4.jpg" /> <a href="Wypozyczenie.html" class="rent-button">Wypożycz</a>
                                              </div>
                                          </a><br/>
                                          <a href="strona_glowna_uzytkownik.php?ksiazka=k4" target="_blank" title="Zobacz recenzje">Miecz przeznaczenia</a>
                                      </div>

                                      <div class="druga">
                                          <a href="strona_glowna_uzytkownik.php?ksiazka=k5" target="_blank" title="Oskar i pani Róża">
                                              <div class="image-container">  <img width="120" src="../../img/5.jpg" /><a href="Wypozyczenie.html" class="rent-button">Wypożycz</a>
                                              </div>
                                          </a><br/>
                                          <a href="strona_glowna_uzytkownik.php?ksiazka=k5" target="_blank" title="Zobacz recenzje">Oskar i pani Róża</a>
                                      </div>

                                      <div class="druga">
                                          <a href="strona_glowna_uzytkownik.php?ksiazka=k6" target="_blank" title="Zbrodnia i kara">
                                              <div class="image-container">     <img width="120" src="../../img/6.jpg" /><a href="Wypozyczenie.html" class="rent-button">Wypożycz</a>
                                              </div>
                                          </a><br/>
                                          <a href="strona_glowna_uzytkownik.php?ksiazka=k6" target="_blank" title="Zobacz recenzje">Zbrodnia i kara</a>
                                      </div>

                                      <div class="druga">
                                          <a href="strona_glowna_uzytkownik.php?ksiazka=k7" target="_blank" title="Krew elfów">
                                              <div class="image-container">    <img width="120" src="../../img/7.jpg" /><a href="Wypozyczenie.html" class="rent-button">Wypożycz</a>
                                              </div>
                                          </a><br/>
                                          <a href="strona_glowna_uzytkownik.php?ksiazka=k7" target="_blank" title="Zobacz recenzje">Krew elfów</a>
                                      </div>

                                      <div class="druga">
                                          <a href="strona_glowna_uzytkownik.php?ksiazka=k9" target="_blank" title="Igrzyska śmierci">
                                              <div class="image-container">   <img width="120" src="../../img/9.jpg" /><a href="Wypozyczenie.html" class="rent-button">Wypożycz</a>
                                              </div>
                                          </a><br/>
                                          <a href="strona_glowna_uzytkownik.php?ksiazka=k9" target="_blank" title="Zobacz recenzje">Igrzyska śmierci</a>
                                      </div>

                                      <div class="druga">
                                          <a href="strona_glowna_uzytkownik.php?ksiazka=k10" target="_blank" title="Zmierzch">
                                              <div class="image-container">   <img width="120" src="../../img/10.jpg" /><a href="Wypozyczenie.html" class="rent-button">Wypożycz</a>
                                              </div>
                                          </a><br/>
                                          <a href="strona_glowna_uzytkownik.php?ksiazka=k10" target="_blank" title="Zobacz recenzje">Zmierzch</a>
                                      </div>

                                      <div class="druga">
                                          <a href="strona_glowna_uzytkownik.php?ksiazka=k11" target="_blank" title="Ostatnie życzenie">
                                              <div class="image-container">   <img width="120" src="../../img/11.jpg" /><a href="Wypozyczenie.html" class="rent-button">Wypożycz</a>
                                              </div>
                                          </a><br/>
                                          <a href="strona_glowna_uzytkownik.php?ksiazka=k11" target="_blank" title="Zobacz recenzje">Ostatnie życzenie</a>
                                      </div>
                                  </div>
                              </div>
